...
def save_model_and_history(model, history, model_path='./saved_models/LeNet_trans.pickle', 
...
def train():
    ...
    model.train(10, train_dataset, callbacks=callbacks, dataset_sink_mode=False)
    history = history_recorder.get_history()
